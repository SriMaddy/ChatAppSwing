...
public class ClientRegistration implements ActionListener {
	JFrame frame;
	...
	private void createObjects() {
		...
		btnAddClient = new JButton("REGISTER");
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		int result = db.registerClient(username, password);
		if (result == 1) {
			JOptionPane.showMessageDialog(frame,
					"Client Registered Successfully", "SUCCESS!",
			...
			JOptionPane.showMessageDialog(frame,
					"Client Registration Failed. Try with new username",
