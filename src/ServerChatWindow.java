...
public class ServerChatWindow implements ActionListener, KeyListener {
	JFrame frame;
	...
	private static ServerChatWindow serverChat = new ServerChatWindow();
	private ClientChatWindow clientChat;
	...
	public static ServerChatWindow getServerChatReference() {
		return serverChat;
	}
	...
	private void createObjects() {
		frame = new JFrame("SERVER CHAT WINDOW");
		panel1 = new JPanel();
		panel2 = new JPanel();
		panel3 = new JPanel();
		panel4 = new JPanel();
	...
	private void sendMsg() {
		...
		db.storeMessage(message, "Server");
		retrivedMsg = "";
		loadMessage();
		clientChat = ClientChatWindow.getClientChatReference();
		clientChat.loadMessage();
		textMsg.setText("");
		textMsg.requestFocus();
	}
